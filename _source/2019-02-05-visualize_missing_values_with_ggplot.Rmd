...
subtitle: "A practical guide how to find and visualize missing data with tidyverse (ggplot2, dplyr, tidyr)"
...
```{r echo=T, message=T, out.width="150%"}
missing.values <- df %>%
    gather(key = "key", value = "val") %>%
